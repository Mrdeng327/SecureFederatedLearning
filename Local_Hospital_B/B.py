...
hyperparams = {
    ...
    "max_features": "log2",  # 字符串
    "min_samples_leaf": 6,  # 数值
    "min_samples_split": 15,  # 数值
    "n_estimators": 120  # 数值
}
...
def request_otm_from_A():
    ...
    final_masked_values = {
        ...
        "min_samples_leaf": masked_values["min_samples_leaf"] - otm_from_A["min_samples_leaf"],
        "min_samples_split": masked_values["min_samples_split"] - otm_from_A["min_samples_split"],
        "n_estimators": masked_values["n_estimators"] - otm_from_A["n_estimators"]
    }
